...
using SistemaVendas.Model.Enums;
namespace SistemaVendas.Data
{
    public class SeedingService
    {

        private SistemaVendasContext _contextDB;
        ...
        public void Seed() {
            if (
                _contextDB.Department.Any() || 
                _contextDB.Seller.Any() || 
                _contextDB.SalesRecord.Any()
                ) 
            {
                return;
            }
            ...
            Seller s2 = new Seller(2, "Maria Green", "Maria@gmail.com", 3000.0, new DateTime(1997, 5, 6), d4);
            Seller s3 = new Seller(3, "Maria Smith", "MariaSmith@gmail.com", 2500.0, new DateTime(1989, 6,27), d2);
            Seller s4 = new Seller(4, "Alex Grey", "Alex@gmail.com", 2500.0, new DateTime(1992, 1, 10), d3);
            Seller s5 = new Seller(5, "Martha Red", "Martha@gmail.com", 2700.0, new DateTime(1990, 8, 9), d4);

            SalesRecord sr1 = new SalesRecord(1, new DateTime(2018,09,25), 11000.0, SalesStatus.Pending, s1);
            SalesRecord sr2 = new SalesRecord(1, new DateTime(2018, 09, 25), 11000.0, SalesStatus.Pending, s1);
            SalesRecord sr3 = new SalesRecord(1, new DateTime(2018, 09, 25), 11000.0, SalesStatus.Pending, s1);
            SalesRecord sr4 = new SalesRecord(1, new DateTime(2018, 09, 25), 11000.0, SalesStatus.Pending, s1);
            ...
            SalesRecord r9 = new SalesRecord(9, new DateTime(2018, 09, 14), 11000.0, SalesStatus.Pending, s3);
            ...
            SalesRecord r20 = new SalesRecord(20, new DateTime(2018, 10, 15), 8000.0, SalesStatus.Billed, s2);
            ...
            _contextDB.Department.AddRange(d1, d2, d3, d4);

            _contextDB.Seller.AddRange(s1, s2, s3, s4, s5);

            _contextDB.SalesRecord.AddRange(
